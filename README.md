...
By default, `derpconnect` generates an ephemeral x25519 private key on startup. To reuse a stable key, set `DERPCONNECT_X25519_PRIVATE_KEY` to a base64-encoded 32-byte x25519 private key.
